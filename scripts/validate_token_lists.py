    ...
    for token in entries:
        ...
        try:
            ...
            if strip_hex_prefix(code) == "":
                ...
                onchain_name = decode_string(client.eth_call(normalized_address, NAME_SELECTOR))
                onchain_symbol = decode_string(client.eth_call(normalized_address, SYMBOL_SELECTOR))
